...
public class ModelSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.EMPRESTIMO: {
				...
				Object result = caseEmprestimo(emprestimo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.FUNCIONARIO: {
				...
				Object result = caseFuncionario(funcionario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.ANTENDENTE: {
				Antendente antendente = (Antendente)theEObject;
				Object result = caseAntendente(antendente);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public Object caseEmprestimo(Emprestimo object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public Object caseFuncionario(Funcionario object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Antendente</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Antendente</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseAntendente(Antendente object) {
		return null;
	}
